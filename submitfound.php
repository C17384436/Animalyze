...
<div class="container">
<h1><b>FOUND PET SUBMISSION FORM</b></h1>
    
<br>
    
  <form method="post" action="submitfound.php">
    ...
    <div class="form-group">
      <label for="county">*County Found:</label>
    ...
    <div class="form-group">
      ...
      <br>
    <button type="submit" class="btn btn-default" name="submitfound">Submit</button>
  </form>
